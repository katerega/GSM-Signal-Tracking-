 ...
 * Original file: /home/henrycg/signal/gpstracker/src/nl/sogeti/android/gpstracker/logger/IGPSLoggerServiceRemote.aidl
 */
...
case TRANSACTION_getLastSignalStrength:
{
data.enforceInterface(DESCRIPTOR);
int _result = this.getLastSignalStrength();
reply.writeNoException();
reply.writeInt(_result);
return true;
}
...
public int getLastSignalStrength() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getLastSignalStrength, _data, _reply, 0);
_reply.readException();
_result = _reply.readInt();
}
finally {
...
static final int TRANSACTION_getLastSignalStrength = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
}
public int loggingState() throws android.os.RemoteException;
public long startLogging() throws android.os.RemoteException;
public void pauseLogging() throws android.os.RemoteException;
